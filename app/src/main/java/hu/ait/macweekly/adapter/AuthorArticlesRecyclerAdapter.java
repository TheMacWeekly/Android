...
/**
 * Created by Sammy Fritsche on 7/15/2018
 */

public class AuthorArticlesRecyclerAdapter extends RecyclerView.Adapter<RecyclerView
        .ViewHolder> {

    private static String LOG_TAG = "AUTHOR_ADAPTER - ";
    ...
    public AuthorArticlesRecyclerAdapter(Context context, ArticleViewClickListener articleClickListener,
